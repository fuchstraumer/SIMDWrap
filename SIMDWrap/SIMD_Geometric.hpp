...
namespace simd {
	...
	static vec8 SIMD_CALL cross(const vec8& v0, const vec8& v1) {

	}

	// Length of this vector, returned as a vector
	static vec8 SIMD_CALL length(const vec8& v0) {
		vec8 prod = dot(v0, v0);
