...
namespace simd {
	...
	public:
		...
		// Unary operators
		vec8& operator+=(vec8 const &other) {
		...
		// Math operators
		vec8 floor(const vec8 &in) {
			return vec8(_mm256_floor_ps(*in.data));
		}

		// Special comparison operators
		static vec8 and_not(const vec8& v0, const vec8& v1) {
	...
	public:
		...
		// Conversion
		static vec8 ConvertToFloat(ivec8 const &a) {
			return vec8(_mm256_cvtepi32_ps(*a.data));
		}
		static vec8 CastToFloat(ivec8 const& a) {
		...
		ivec8& operator+=(ivec8 const &other) {
		...
		ivec8 const operator+(ivec8 const &a) const {
		...
		ivec8 const operator>>(int const& count) const {
		...
		ivec8 operator>(ivec8 const& other) const {
		...
		static ivec8 and_not(ivec8 const& v0, ivec8 const& v1) {
			return ivec8(_mm256_andnot_si256(*v0.data, *v1.data));
		}
		static ivec8 xor (ivec8 const& v0, ivec8 const& v1) {
			return ivec8(_mm256_xor_si256(*v0.data, *v1.data));
		}
		static ivec8 not(ivec8 const& v0) {
		...
		static vec8 dot(const vec8& v0, const vec8& v1) {
